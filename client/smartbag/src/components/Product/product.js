    ...
    <div className="product">
      ...
      <div className="productpg center ">
        ...
        <div className="white card row z-depth-1" id="pdt_bt">
          ...
          <Item src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUxZ9MaxthdxNTdb-FjD-qfpT_0JApnnGcEvKG2jivOKoPH7uQ081f4plHi63qdtj5l2U&usqp=CAU" name="Ashirwaad aata"/>
          <Item src="https://assets.gopaisa.com/unsafe/0x0/https://gpcdn.ams3.cdn.digitaloceanspaces.com/deals/flipkart-grocery-breakfast-items-corn-flakes-chocos-offer-discount-1529314833.jpg" name="Kellog's Corn Flakes"/>
          <Item src="https://diginamaste.com/wp-content/uploads/2021/05/grocery_flour_fortune_besan-1.png" name="Fortune Besan"/>
          <Item src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-6OCjpS_pyReuFpkY8e4ouqPn_z0_JoR6W3GNlxWtbA-GmzCp7V680PjCf6CgoK8gGUg&usqp=CAU" name="Nestle Maggi"/>
        </div>
        <br />
        <div className="white card row z-depth-1" id="pdt_bt">
          <p className="black-text" id="pdt_bt_head">
